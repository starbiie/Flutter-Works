      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 15,),
            Text('Glod to see you ',style: TextStyle(color: Colors.white,fontSize: 25,fontWeight: FontWeight.w100),),
            SizedBox(height: 15,),
        Padding(
...
Padding(
  padding: const EdgeInsets.only(left: 245.0,top: 15,),
...
SizedBox(height: 30,),
            ...
            SizedBox(height: 50,),
            Text("__________________On Logins All_____________________",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w100),),
SizedBox(height: 30,),
            Row(
              children: [
Padding(
...
borderRadius: BorderRadius.circular(15)
               ...
               Row(
                ...
                Text("Sign Up Now",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 15),),],
              ),
