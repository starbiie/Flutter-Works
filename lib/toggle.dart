...
class toggl extends StatefulWidget {
  const toggl({Key? key}) : super(key: key);

  @override
  State<toggl> createState() => _togglState();
}

class _togglState extends State<toggl> {
  bool onoff=false;
  bool isonoff=false;
  bool ischeck=false;
  bool ischeck1=false;
...
SizedBox(height: 35,),
            ...
            ListTile(
              title: Text('Allow notifications',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18.0),),
